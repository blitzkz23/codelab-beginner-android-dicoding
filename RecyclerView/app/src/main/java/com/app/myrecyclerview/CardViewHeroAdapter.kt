...
class CardViewHeroAdapter(private val listHero: ArrayList<Hero>) : RecyclerView.Adapter<CardViewHeroAdapter.CardViewViewHolder>() {
	inner class CardViewViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
		var imgPhoto: ImageView = itemView.findViewById(R.id.ich_img_item_photo)
		var tvName: TextView = itemView.findViewById(R.id.ich_tv_item_name)
		var tvDetail: TextView = itemView.findViewById(R.id.ich_tv_item_detail)
